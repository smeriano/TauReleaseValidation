#!/usr/bin/env bash
# Run after validation finishes. Preview: bash upload_tau_2026_mc.sh --dry-run
...
OUTPUT = 'tau_relval_auto_outputs_MC_Run3_2026'
STATUS = 'status.tsv'
CAMPAIGN = '17_0_0_pre3_2026MC_vs_17_0_0_pre2_2026MC'
GT = '160X_mcRun3_2026_realistic_v6'
TIER = 'MINIAODSIM'
EXPECTED = [('ZMM', 'noPU'), ('ZEE', 'noPU'), ('ZTT', 'noPU'), ('TTbar', 'noPU'), ('ZMM', 'PU'), ('ZEE', 'PU'), ('ZTT', 'PU'), ('TTbar', 'PU')]
